...
* Fri Sep 11 2026 Neal Gompa <ngompa@fedoraproject.org> - 1.4.0-1
- Update to 1.4.0
- Add patch to use RepoConfigOverride API to support repo config in /usr

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.6-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 25 2026 František Zatloukal <fzatlouk@redhat.com> - 1.3.6-2
- Rebuilt for fmt/spdlog

* Sat Jun 20 2026 Gordon Messmer <gmessmer@redhat.com> - 1.3.6-1
